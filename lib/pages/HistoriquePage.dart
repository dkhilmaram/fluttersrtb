...
class _HistoriquePageState extends State<HistoriquePage>
  ...
  Future<void> _fetchAll() async {
    ...
    try {
      final response = await http
          .get(Uri.parse(
              'http://192.168.1.22:8000/billetterie/voyages/$id/tickets'))
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          final total = onlineOnly.length + syncedOffline.length + failed.length;
          _showToast('$total ticket(s) chargés avec succès');
          return;
        }
      }
    } catch (_) {}
    ...
    _showToast('Hors-ligne — tickets locaux uniquement', isWarning: true);
  }
  ...
  Future<void> _retrySync() async {
    ...
    _showToast('Synchronisation en cours…', isInfo: true);
    ...
    if (result.failed > 0) {
      ...
      _showToast('${result.synced} ticket(s) synchronisés ✓');
    } else {
      _showToast('Aucun ticket à synchroniser', isInfo: true);
    }
  }
  ...
  Color _tarifColor(String type) {
    ...
    if (t.contains('armée') || t.contains('armee') ||
        t.contains('garde') || t.contains('police'))
      return const Color(0xFF1E40AF);
    if (t.contains('douane') || t.contains('ministère') ||
        t.contains('ministere'))
      return const Color(0xFF374151);
    if (t.contains('municipalité') || t.contains('municipalite') ||
        t.contains('scolaire') || t.contains('institution') ||
        t.contains('autre'))
  ...
  IconData _tarifIcon(String type) {
    ...
    if (t.contains('réduit') || t.contains('reduit'))
          ...
          : errorMessage != null
              ...
              : NestedScrollView(
                  headerSliverBuilder: (_, __) => [
                    SliverToBoxAdapter(
                      child: _buildSliverHeader(depart, arrivee,
                          asSliverBox: true),
                    ),
                  ],
                  body: TabBarView(
  ...
  Widget _buildSliverHeader(String depart, String arrivee,
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          final prev =
              idx > 0 ? tickets[idx - 1] as Map<String, dynamic> : null;
      ...
      child: Column(children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
                bottom:
                    BorderSide(color: color.withOpacity(0.12))),
          ),
          child: Row(children: [
            Flexible(
              child: Container(
            ...
            if (qty > 1) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                        color: navyMid.withOpacity(0.15))),
                child: Text('×$qty',
                    style: const TextStyle(
                        color: navyMid,
                        fontSize: 12,
