...
class _NouveauTicketPageState extends State<NouveauTicketPage> {
  ...
  try {
    final idLigne = widget.voyage['id_ligne']; // ← was 'id', now 'id_ligne'
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            _confirmRow(Icons.location_on, 'Montée', pointDepart!),
            const SizedBox(height: 8),
            _confirmRow(Icons.flag, 'Descente', pointArrivee!),
            const SizedBox(height: 8),
            _confirmRow(Icons.label, 'Tarif', typeTarif!),
            const SizedBox(height: 8),
            _confirmRow(Icons.people, 'Quantité', '$quantite ticket${quantite > 1 ? 's' : ''}'),
            if (_discountPct > 0) ...[
              ...
              Row(children: [
                ...
                Text('${_prixNormal} × $quantite → ${_prixTotal} ms',
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              setState(() {
                ticketsVendus += quantite;
                montantTotal += _prixTotal!;
                pointDepart = null;
                pointArrivee = null;
                typeTarif = null;
                quantite = 1; // reset to 1 after sale
              });
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text(_prixTotal == 0
                    ? '✅ $quantite passage(s) gratuit(s) enregistré(s)'
                    : '✅ $quantite ticket(s) vendus : ${_prixTotal} millimes'),
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _counterBox(Icons.confirmation_number, 'Tickets vendus',
                      '$ticketsVendus', srtbBlue),
                  Container(width: 1, height: 40, color: srtbBlue.withOpacity(0.2)),
                  _counterBox(Icons.monetization_on, 'Total collecté',
                      '$montantTotal ms', Colors.green.shade700),
                ],
              ),
            ),
                  ...
                  : errorMessage != null
                      ...
                      : Column(
                          ...
                          children: [
                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Icon(
                                          pct == 0 ? Icons.card_giftcard
                                              : discount > 0 ? Icons.discount
                                              : Icons.person,
                            ...
                            // ── Montée ──
                            const Text('Point de montée',
                                style: TextStyle(fontWeight: FontWeight.bold,
                                    fontSize: 14, color: srtbBlue)),
                            const SizedBox(height: 8),
                            _dropdownCard(
                              icon: Icons.location_on,
                              hint: 'Choisir le point de montée',
                              value: pointDepart,
                              items: arrets,
                              onChanged: (v) => setState(() {
                                pointDepart = v;
                                if (pointArrivee == v) pointArrivee = null;
                              }),
                            ),
                            ...
                            _dropdownCard(
                              icon: Icons.flag,
                              hint: 'Choisir le point de descente',
                              value: pointArrivee,
                              items: arrets,
                                ...
                                child: Column(children: [
                                  ...
                                  if (_discountPct > 0)
                                    Padding(
                                      ...
                                      child: Text(
                                        'Réduction de $_discountPct% appliquée',
                                        style: const TextStyle(
                                            color: Colors.orange,
                                            fontSize: 12,
                                            fontWeight: FontWeight.w600),
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: _canValidate ? _vendreTicket : null,
