  ...
  Future<void> _cloturerVoyage() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success']) {
          setState(() { isCloture = true; isCloturing = false; });
          ...
          if (mounted) _showSnack(data['message'] ?? 'Erreur', isError: true);
        }
      }
    } catch (e) {
      setState(() => isCloturing = false);
      if (mounted) _showSnack('Impossible de clôturer le voyage', isError: true);
    }
  }
              ...
              Container(
                ...
                child: Image.asset('assets/images/logo_srtb.png',
                    ...
                    errorBuilder: (_, __, ___) =>
                        Icon(Icons.directions_bus, size: 44,
        ...
        style: TextStyle(color: Colors.grey.shade400, fontSize: 13)),
            ...
            : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                _actionBtn(
                  ...
                  enabled: !isCloturing,
                  colors: [const Color(0xFF7F1D1D), const Color(0xFFDC2626)],
                  ...
                  child: OutlinedButton(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      Icon(Icons.arrow_back_ios_new,
                          size: 14, color: isCloturing
                              ? Colors.grey.shade300 : navyMid),
                      const SizedBox(width: 8),
                      Text('Annuler',
                          style: TextStyle(
