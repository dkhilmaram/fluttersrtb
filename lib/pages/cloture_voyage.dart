...
class _ClotureVoyagePageState extends State<ClotureVoyagePage> {
  ...
  void _showToast(String msg, {bool isError = false}) {
    ...
    final color = isError ? const Color(0xFFB91C1C) : const Color(0xFF15803D);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child:
                  isCloture ? _buildSuccess() : _buildForm(depart, arrivee),
            ),
          ],
        ),
      ),
        ...
        children: [
          ...
          Container(
            ...
            child: Image.asset(
              ...
              fit: BoxFit.contain,
              errorBuilder: (_, __, ___) => Icon(Icons.directions_bus,
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            shape: BoxShape.circle,
            border: Border.all(color: navyMid.withOpacity(0.3), width: 2),
          ),
        ...
        const Text('Voyage clôturé !',
            style: TextStyle(
                fontSize: 22, fontWeight: FontWeight.bold, color: navyDark)),
        const SizedBox(height: 8),
        Text('Tous les secteurs ont été clôturés.',
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: navyLight.withOpacity(0.15), width: 1.5),
            boxShadow: [
              BoxShadow(
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(color: navyMid.withOpacity(0.3), width: 1.5),
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.arrow_back_ios_new,
                    size: 14,
                    color: isCloturing ? Colors.grey.shade300 : navyMid),
                const SizedBox(width: 8),
                Text('Annuler',
                    style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                        color:
                            isCloturing ? Colors.grey.shade300 : navyMid)),
              ],
            ),
          ),
        ),
