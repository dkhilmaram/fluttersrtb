  ...
  _fetchAll() async {
    ...
    try {
      ...
      final r1 = await http
          .get(
            Uri.parse(
              'http://10.19.204.100:8000/billetterie/voyages/$id/segment/actif',
            ),
          )
          .timeout(
            const Duration(
      ...
      final r2 = await http
          .get(
            Uri.parse(
              'http://10.19.204.100:8000/billetterie/voyages/$id/segments',
            ),
          )
          .timeout(
            const Duration(
  ...
  _ouvrirProchainSecteur() async {
    ...
    try {
      final response = await http
          .put(
            Uri.parse(
              'http://10.19.204.100:8000/billetterie/voyages/$_voyageId/segment/ouvrir',
            ),
            headers: {
  ...
  _cloturerSecteurActif() async {
    ...
    try {
      final response = await http
          .put(
            Uri.parse(
              'http://10.19.204.100:8000/billetterie/voyages/$id/segments/$idSeg/cloturer',
            ),
            headers: {
              'Content-Type': 'application/json',
            },
      ...
      if (!tousClotures &&
        ...
        try {
          final openResponse = await http
              .put(
                Uri.parse(
                  'http://10.19.204.100:8000/billetterie/voyages/$id/segment/ouvrir',
                ),
                headers: {
                  'Content-Type': 'application/json',
                },
