...
class _VenteTicketsPageState extends State<VenteTicketsPage> {
  ...
  Future<void> _checkStatut() async {
    ...
    if (id == null) { setState(() => isLoading = false); return; }
    try {
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('Voyage clôturé — Aucune vente possible',
              ...
              child: Row(children: [
                Container(
                  ...
                  child: Icon(Icons.directions_bus,
                      color: isCloture ? Colors.grey : navyMid, size: 24),
                ),
                ...
                : Column(children: [
                    ...
                    if (!isCloture && hasId) ...[
                      _actionBtn(
                        ...
                        icon: Icons.route,
                        colors: [const Color(0xFF0D6E5E), const Color(0xFF0D9E87)],
                    ...
                    if (!isCloture && hasId) ...[
                      ...
                      _actionBtn(
                        ...
                        colors: [const Color(0xFF9B1C1C), const Color(0xFFDC2626)],
                        onTap: () async {
