        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Text('${widget.agent['prenom']} ${widget.agent['nom']}',
                                ...
                                child: Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Stack(
                                      ...
                                      children: [
                                        Icon(Icons.directions_bus, color: iconColor, size: 32),
                                        if (isLocked)
                                          Positioned(
                                            right: -6, bottom: -4,
                                            child: Container(
                                    ...
                                    Column(children: [
                                      ...
                                      Icon(
                                        ...
                                        color: isLocked ? Colors.orange.shade400 : Colors.grey,
                                      ),
                                    ]),
                                  ]),
                                ),
