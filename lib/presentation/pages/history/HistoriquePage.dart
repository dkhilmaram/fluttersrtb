...
class _HistoriquePageState
  ...
  _fetchAll() async {
    ...
    final localRows = await TicketDao.getTicketsByVoyage(
      id,
    );
    ...
    try {
      ...
      if (response.statusCode ==
        ...
        if (data['success'] ==
          ...
          final freshRows = await TicketDao.getTicketsByVoyage(
            id,
          );
          ...
          final pendingCount = todayMerged
              .where(
                (
                  t,
                ) =>
