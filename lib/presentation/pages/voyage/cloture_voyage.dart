          ...
          Container(
            ...
            child: Image.asset(
              ...
              errorBuilder: (_, __, ___) =>
                  Icon(Icons.directions_bus, size: 44, color: Colors.red.shade700),
            ),
          ),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            shape: BoxShape.circle,
            border: Border.all(
                color: AppTheme.navyMid.withOpacity(0.3), width: 2),
          ),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: AppTheme.navyLight.withOpacity(0.15), width: 1.5),
            boxShadow: [
              BoxShadow(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.directions_bus,
                        color: AppTheme.navyMid, size: 22),
                  ),
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(
                  color: AppTheme.navyMid.withOpacity(0.3), width: 1.5),
